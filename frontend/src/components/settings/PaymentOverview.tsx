  ...
  return (
    <div className="min-h-screen bg-[#FCFBF7] px-6 py-10 flex flex-col items-center">
      <div className="w-full max-w-3xl">
          ...
          <div className="overflow-x-auto">
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={data}>
                ...
                <YAxis stroke="#888" />
                <Tooltip wrapperStyle={{ backgroundColor: "#fff", padding: "10px", borderRadius: "5px" }} />
        ...
        <div className="mt-6 bg-white p-6 rounded-lg shadow-md flex flex-col space-y-4">
          <label className="text-gray-700 font-semibold">Download financial report for this period</label>
          <div className="flex space-x-4">
            <select className="border rounded px-4 py-2" value={month} onChange={(e) => setMonth(e.target.value)}>
              {[
            ...
            <select className="border rounded px-4 py-2" value={year} onChange={(e) => setYear(e.target.value)}>
